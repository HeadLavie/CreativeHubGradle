CreativeHubGradle is a lightweight API testing project that automates the user lifecycle, including creation, retrieval, authentication, token refresh, and deletion.
Features
