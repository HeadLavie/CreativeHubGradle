...
class SampleTest {
    ...
    // todo
    //  1. пароль имеет 8 символов всегда, нет вариантивности
    //  2. можно ли реализовать UserResponse как child class от User?
    //  3. не делаются папки для тестов
    //  4. датагенерейт и датаинкорректдатагенерейт - все в одном классе
    //  5. на хабре читать про ламбок
